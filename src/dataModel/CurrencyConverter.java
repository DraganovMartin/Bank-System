...
public class CurrencyConverter implements Serializable {
     ...
     * to the sum of the values of both arguments, according to converter the
     * exchange rates. Returns NULL if either currency is not supported.
     *
     ...
     * of both arguments, according to converter the exchange rates. The
     ...
     * @param b the second argument.
     *
     * @return a {@link Money} object with value equal to the sum of the values
     * of both arguments, according to converter the exchange rates. The
     * currency of the result is determined by the currency of the first
     * argument. Returns NULL if either currency is not supported. Calls
     * {@link #calcSum(dataModel.Money, dataModel.Money, dataModel.models.Currency)}
