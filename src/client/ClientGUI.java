...
public class ClientGUI implements MessageHandler {
    ...
    public static void main(String[] args) {
         ...
         *
         * // 3. Simulate receiving the message update1 from the client (will be
         * automatic): clientGUI.handle(update1);
         *
         ...
         * Update("nodescription", null, true, profileData1); }
         *
         * // 3. Simulate receiving the message update2 from the client (will be
         * automatic): clientGUI.handle(update2);
         *
